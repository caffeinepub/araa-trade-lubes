    ...
    <div className="space-y-6">
      ...
      <Dialog open={isSummaryDialogOpen} onOpenChange={setIsSummaryDialogOpen}>
        <DialogContent className="max-w-4xl max-h-[80vh] overflow-y-auto">
          <DialogHeader>
            <DialogTitle>
              Financial Summary - {selectedCustomer?.name}
            </DialogTitle>
            <DialogDescription>Detailed financial overview</DialogDescription>
          </DialogHeader>
          {selectedCustomer && (
            <CustomerFinancialSummary customer={selectedCustomer} />
          )}
        </DialogContent>
      </Dialog>
      ...
      <AlertDialog open={deleteDialogOpen} onOpenChange={setDeleteDialogOpen}>
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              This will permanently delete {selectedCustomer?.name}. This action
              cannot be undone.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
